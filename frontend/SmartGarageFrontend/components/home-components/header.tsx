...
// Get the DEFAULT menu items from Navbar1
...
// But we need to FIX the "#" URLs to real ones
                            ...
                            <ul className="flex gap-8 text-sm">
                                {menuItems.map((item, index) => (
                                    <li key={index}>
                                        <Link
                                            href={item.href}
                                            className="text-muted-background hover:text-accent-foreground block duration-150">
                                            <span>{item.name}</span>
                                        </Link>
                                    </li>
                                ))}
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                <Button
                                    ...
                                    <Link href={defaultNavbarProps.auth.login.url}>
                                        <span>{defaultNavbarProps.auth.login.title}</span>
                                    </Link>
                                </Button>
                                {/*<Button*/}
                                {/*    asChild*/}
